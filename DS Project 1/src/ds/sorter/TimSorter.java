...
public class TimSorter<E extends Comparable<E>> implements Sorter<E> {
    ...
    public void insertionSort(List<E> input, int left, int right) {
        ...
        for (int x = left + 1; x <= right; x++) {
            ...
            int y = x - 1;
            // we compare then check if the element is greater thatn our current element, if so, we set it to y+1 index 
    ...
    // delete this, just for testing purposes only
    ...
    // tester main method you can delete this 
